...
const projects: Array<ProjectsType> = [
  ...
  },
  {
    ...
    screenshots: [
      { label: 'IML store', picture: imlStore },
      { label: 'Product detail', picture: imlProductDetail },
      { label: 'medical appointment picker', picture: imlNewAppointment },
      { label: 'IML for companies', picture: imlForCompnies },
      { label: 'IML branch handler', picture: imlBranches },
      { label: 'Control of business days for appointments', picture: imlbranchManeger },
      { label: 'Control of appointment times', picture: imlHoursControl },
      { label: 'Medical appointment list', picture: imlAppointmentsList },
      { label: 'Employees handler', picture: imlEmployeesList },
    ],
  },
  {
    ...
    screenshots: [
      { label: 'Feminnelife landing', picture: feminnelife1 },
      { label: 'Feminnelife store', picture: feminnelife2 },
      { label: 'List of tutorials for members', picture: feminnelife3 },
      { label: 'Specific exercise routine', picture: feminnelife4 },
      { label: 'Detail exercise routine', picture: feminnelife5 },
      { label: 'Video tutorial of an exercise', picture: feminnelife6 },
      { label: 'Group real-time chat', picture: feminnelife7 },
      { label: 'Sales list', picture: feminnelife8 },
      { label: 'Panel to manage programs', picture: feminnelife9 },
    ],
  },
  {
    ...
    screenshots: [
      { label: 'ADN Landing', picture: adn1 },
      { label: 'ADN categories', picture: adn2 },
      { label: 'List of steakhouses', picture: adn3 },
      { label: 'Steakhouses detail', picture: adn4 },
      { label: 'List of accesories', picture: adn5 },
      { label: 'Steakhouses builder', picture: adn6 },
      { label: 'ADN contact', picture: adn7 },
    ],
  },
  {
    ...
    screenshots: [
      { label: 'Landing', picture: sc1 },
      { label: 'Products list', picture: sc2 },
      { label: 'Product detail', picture: sc3 },
      { label: 'About', picture: sc4 },
      { label: 'Contact', picture: sc5 },
      { label: 'Branches', picture: sc6 },
    ],
  },
  {
    ...
    screenshots: [
      { label: 'Landing', picture: ayb1 },
      { label: 'Categories', picture: ayb2 },
      { label: 'Products list', picture: ayb3 },
      { label: 'Product detail', picture: ayb4 },
      { label: 'About', picture: ayb5 },
      { label: 'Contact', picture: ayb6 },
    ],
  },
  {
